  ...
  return `
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.4; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #ffffff; padding: 20px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 12px 12px;">
        <h2 style="color: #A8D5BA; margin: 0 0 15px 0; font-size: 18px;">¡Reserva Confirmada!</h2>
        
        <p style="margin: 0 0 10px 0;">Hola <strong>${data.patientName}</strong>,</p>
        <p style="margin: 0 0 15px 0;">Tu reserva ha sido confirmada exitosamente. Aquí están los detalles:</p>
        ...
        <h3 style="color: #60c3e7; margin: 0 0 10px 0; font-size: 14px;">Tus sesiones programadas:</h3>
        ...
        <p style="margin: 0 0 10px 0; font-size: 14px;">Te esperamos. Si necesitas reagendar, por favor contáctanos con 24 horas de anticipación.</p>
